...
/*
 *  slightly modified by jerome bordallo to better match url to exact rule
 */
class Route
{
	/**
...
//echo "uri:$uri" . PHP_EOL;
                        $uri_slashes = explode('/',$uri);
//print_r($uri_slashes);
//echo "listuri:$listUri" . PHP_EOL . PHP_EOL;
                        $listuri_slashes = explode('/',$listUri);
//print_r($listuri_slashes);
			if (preg_match("#^$listUri$#", $uri) && count($uri_slashes) == count($listuri_slashes))
			{
				/**
				* Replace the values
				*/
