...
// detect if it's mobile. If not, redirect to $docroot_desktop (desktop/home page)

// The following is a function copied from CMS root config.php:
// TODO: make CMS root and mobile share some functions
// 
